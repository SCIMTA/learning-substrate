...
// Configure the pallet-token in pallets/token.
impl pallet_token::Config for Runtime {
	type Event = Event;
	type Currency = Balances;
}

// Configure the pallet-plutocracy in pallets/plutocracy.
impl pallet_plutocracy::Config for Runtime {
	type Event = Event;
}
